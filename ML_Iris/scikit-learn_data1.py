...
# iris.target 에 저장된 세개의 고유한 클래스 레이블을 반환
# 붓꽃 클래스 이름 : Iris-setosa, Iris-versicolor, Iris-virginica 는 이미 정수로 저장되어 있음 (0,1,2)
print('클래스 레이블 : ', np.unique(y))

# 훈련된 모델 성능을 평가하기 위한 데이터셋을 훈련 데이터셋과 테스트 데이터셋으로 분할
# 30% 는 테스트데이터, 70%는 훈련 데이터
