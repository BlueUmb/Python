...
"""
    keras : tensorflow 를 활용해서 인공지능을 더 쉽게 만들 수 있도록 도와주는 소프트웨어
            tensorflow 의 기본 기능으로 내장됨
"""
...
model = keras.Sequential([
    keras.layers.Dense(3),                           # 첫번째 층은 3개의 유닛을 가지고 있으며 한 레이어 구성
    keras.layers.Dense(128, activation= "relu"),     # 두번쨰 층은 128개의 유닛을 가지고 한 레이어 구성, 렐루 함수
