'''
    1. 파이썬 리스트 & 넘파이
        ...
        5) 넘파이의 강력한 배열 프로그래밍 기능이 넘파이가 인기있는 이유임.
            - 스칼라(scalar) 언어의 for문
                - 각각의 원소들을 순차적으로 처리해야 함
            - 데이터 병렬성(parallelism) 방식
                - 데이터를 잘개 쪼개어 각각에 대해 동일한 연산을 독립적으로 수행하는 방식
                ...
                - 벡터화 연산
                    - 프로그래머가 효율적으로 고성능의 데이터 병렬 처리를 할수 있게 해줌
